...
export const AddAppointment = () => {
    ...
    return (
        <div>
            <button onClick={setToggleForm} className={`bg-blue-400 text-white px-2 py-3 w-full text-left rounded-t-md ${toggleForm ? 'rounded-t-md' : 'rounded-md'} transition-all`}>
